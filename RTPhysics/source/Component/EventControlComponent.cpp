...
void EventControlComponent::AddGuiButton()
{
    ...
    gui->addButton(core::rect<int>(screen.Width-75,screen.Height-300,screen.Width-5,screen.Height-250), NULL, GUI_ID_BUTTON_ROLL_SHOOT, L"Shoot");
#else
    ...
    gui->addButton(core::rect<int>(screen.Width-75,screen.Height-350,screen.Width-5,screen.Height-300), NULL, GUI_ID_BUTTON_ROLL_SHOOT, L"Shoot");
#endif
